<template>
 <div class="bg-white sticky-top">
      ...
      background-image: url(https://images.unsplash.com/photo-1480399129128-2066acb5009e?ixlib=rb-1.2.1
      &ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1950&q=80);
      ...
      <div class="row justify-content-between mt-4 mb-7">
        <div class="col-md-7">
          ...
          border-left-0 border-right-0 mb-3" id="accordionExample">
        ...
        <div class="col-md-4">
          ...
          <a href="./checkout.html" class="btn btn-dark btn-block rounded-0 py-3">Lorem ipsum</a>
        </div>
      </div>
    </div>
    </div>
